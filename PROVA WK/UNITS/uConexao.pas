...
begin
     ...
     FConexaoBanco.ConnectionString := 'Provider=MSDASQL.1;Password=root;Persist Security Info=True;User ID=root;Data Source=conexao_prova;Initial Catalog=wk_prova;';
